...
class LocationSearchViewController: UIViewController, UISearchBarDelegate, CLLocationManagerDelegate {
...
//    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int return searchResultData.count
//    }
//    
